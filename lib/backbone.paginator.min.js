...
parseRecords:function(a,b){return a&&2===a.length&&q(a[0])&&o(a[1])?a[1]:a},/**
       ...
       @return {XMLHttpRequest}
    */
fetch:function(b){b=b||{};var c=this._checkState(this.state),e=this.mode;"infinite"!=e||b.url||(b.url=this.links[c.currentPage]);var h=b.data||{},k=b.url||this.url||"";p(k)&&(k=k.call(this));var l=k.indexOf("?");l!=-1&&(f(h,d(k.slice(l+1))),k=k.slice(0,l)),b.url=k,b.data=h;
// pick the appropriate query param keys to map according to the mode
var n="client"==this.mode?j(this.queryParams,"sortKey"):g(j(this.queryParams,r(A.queryParams)),"order","directions","totalPages","totalRecords");
// map the query params to the data object used by the underlying ajax lib
// to construct the query string
i(n,function(b,d){b=p(b)?b.call(this):b,null!=c[d]&&null!=b&&a.isUndefined(h[b])&&(h[b]=c[d])},this);var q=p(this.queryParams.sortKey)?this.queryParams.sortKey.call(this):this.queryParams.sortKey,t=p(this.queryParams.order)?this.queryParams.order.call(this):this.queryParams.order;if(null!=q&&null!=c.sortKey&&null!=t&&null!=c.order)if(o(c.order)){h[t]=[];for(var u=0;u<c.order.length;u++)h[t].push(this.queryParams.directions[c.order[u]])}else h[t]=this.queryParams.directions[c.order+""];for(var v=m(g(this.queryParams,r(A.queryParams))),u=0;u<v.length;u++){var x=v[u],y=x[1];y=p(y)?y.call(this):y,null!=y&&(h[x[0]]=y)}if("server"!=e){var z=this,B=this.fullCollection,C=b.success;
// silent the first reset from backbone
return b.success=function(a,c,d){
// make sure the caller's intent is obeyed
d=d||{},s(b.silent)?delete d.silent:d.silent=b.silent;var g=a.models;"client"==e?B.reset(g,d):(B.add(g,f({at:B.length},f(d,{parse:!1}))),z.trigger("reset",z,d)),C&&C(a,c,d)},w.fetch.call(this,f({},b,{silent:!0}))}return w.fetch.call(this,b)},/**
